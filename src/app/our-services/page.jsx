...
const OurServices = () => {
  ...
  return (
    <>
      <div className="bg-[#f53e2e] page-content w-full z-[10000] origin-top fixed top-[100px] flex items-center justify-center h-[90vh] font-[helveticaNeue] text-[10vw]">
      ...
      >
        <div className="py-[45px] ">
          ...
          <section className="grid grid-cols-4 mt-[50px] md:grid-cols-2 lg:grid-cols-3 max-sm:grid-cols-1 gap-[30px]">
            {[
              {
                t: `تصميم الهوايات التــــجـــــاريـــــــــــــــة`,
...
وتــصــــــــويــــر الفيديــــو`,
                des: `يوجد فريق متخصص في تصوير المنتجات وتصوير مقاطع الفيديو الإعلانية بجودة واحترافية عالية، لنكمِّل جمالية البروازوتظهر في أبهى حُلَّة.`,
              },
              {
                t: `كتابة المحتوى`,
...
أبسلوب جذاب بما يتناسب مع
معايير شكل المحتوى الخاص.`,
              },
              {
                t: `التواصل الداخلي
للـــــــشــــــركـــــــــات`,
                des: `نسعى إليجاد أفكار مبتكرة ومميزة لتعزيز روح الفريق وتعزيز التواصل الداخلي في الشركة، نحن نضمن تنظيم فعاليات تجمع بين الترفيه والتفاعل الاجتماعي لضمان تجربة لا تنسى للموظفين، اعتمد علينا لجعل تجارب التواصل الداخلي في شركتك تحقق أهدافك وتعزز روح العمل الجماعية.`,
              },
              {
                t: `االفتتاحات
والفعاليات`,
