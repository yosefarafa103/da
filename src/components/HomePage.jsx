        ...
        >
          <div className="font-[helveticaNeue] flex-[1]">
            ...
            <p className="text-[16px]">
              ...
              احنا وكالة تسويق انطلقنا عام 2023 ودخلنا هذا المجال من أوسع
              أبوابه نعمل على تصميم الهوية التجارية وكتابة المحتوى وتنظيم
              الفعاليات الداخلية للشركات والتصوير الفوتوغرافي لنجعل من صور
              منتجاتك قصة تحكي بفريق من مصوري ومخرجي دبوس حيث نجمع بين التوثيق
              والابداع بجانب من إعداد الافتتاحات والفعاليات .. يعني مزيج من
              العصف الذهني, مع الأخذ بعين الاعتبار ان رضا عميلنا هو الأهم
            </p>
            <Link
              href="/contact-us"
